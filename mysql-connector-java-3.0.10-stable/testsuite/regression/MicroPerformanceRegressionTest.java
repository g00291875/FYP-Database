...
/**
 * Microperformance benchmarks to track increase/decrease in performance
 * of core methods in the driver over time.
 *
 * @author Mark Matthews
 * 
 * @version $Id: MicroPerformanceRegressionTest.java,v 1.1.2.1 2003/12/12 20:45:41 mmatthew Exp $
 */
public class MicroPerformanceRegressionTest extends BaseTestCase {
    ...
    public static void main(String[] args) throws Exception {
    	new MicroPerformanceRegressionTest("testResultSetAccessors").run();
    }
    
    /**
     * Tests result set accessors performance.
     *
     * @throws Exception if the performance of these methods does
	...
	private void checkTime(String testType, double avgExecTimeMs) throws Exception {
		...
		assertTrue("Average execution time of " + avgExecTimeMs + " ms. exceeded baseline * leeway of " + acceptableTime + " ms.", (avgExecTimeMs <= acceptableTime));
	}
