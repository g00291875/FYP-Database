 ...
 * 
 * Test case provided by Johnny Macchione from bug database record BUG#884.
 * 
 ...
 * 
 * <p>"A Connection-EventListener will also be notified when a fatal error
occurs, 
 ...
 *
 * <p>"A connection pool manager shuts down a physical connection by calling
the
...
public final class PooledConnectionRegressionTest extends BaseTestCase {
    ...
    public static void main(String[] args) {
        TestRunner.run(PooledConnectionRegressionTest.suite());
    }
